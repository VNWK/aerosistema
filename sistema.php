...
<script src="scriptsSistema/sistema.js"></script>
<script src="scriptsSistema/modalSistema.js"></script>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="intro-message">
                        ...
                        <div class="col-lg-4">
                                <button id="clicky" class="btn btn-default btn-lg"><i class="fa fa-keyboard-o fa-fw"></i> <span class="network-name">&nbsp Crear Usuario &nbsp</span></button>
                                <?php include "sistema/crearUsuarios.php";?>
                        </div>                               
                        <div class="col-lg-4">
                                <button id="clicky2" class="btn btn-default btn-lg"><i class="fa fa-desktop fa-fw"></i> <span class="network-name"> Modificar Usuario </span></button>
                                <?php include "sistema/modUsuarios.php";?>
                        </div>                               
                      <div class="col-lg-2"></div>                             
                        </div>
                        </div>
